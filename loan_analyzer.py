...
average_loan_amount = loans_total / total_number
...
for buy_loan in loans:
    loan_price = buy_loan["loan_price"]
    

    if buy_loan["loan_price"]<= 500:
        inexpensive_loans.append(buy_loan)
    
print("Buy these loans: ", inexpensive_loans)
...
with open(csvpath, 'w', newline= '') as csvfile:
    ...
    for row in data:
            csvwriter.writerow(buy_loan.values())
